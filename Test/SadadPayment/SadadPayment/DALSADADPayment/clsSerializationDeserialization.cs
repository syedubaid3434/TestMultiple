    ...
    public class clsSerializationDeserialization<T> where T : class
    {
        ...
        public static string Serialize<t>(T value)
        {
            ...
            catch (Exception ex)
            {
                ...
                objClsDatabase.LogError("clsSerializationDeserialization_Serialize", ex.Message);          
            }
            return result;
        }
        ...
        public static T Deserialize<t>(string XMLstring)
        {
            ...
            catch (Exception ex)
            {
                ...
                objClsDatabase.LogError("clsSerializationDeserialization_Deserialize", ex.Message);      
            }
            return result;
        }
    }
