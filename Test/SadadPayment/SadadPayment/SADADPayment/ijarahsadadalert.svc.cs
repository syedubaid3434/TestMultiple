...
namespace SADADPayment
{
    ...
    public class IjarahSadadPaymentAlert : IIjarahSadadPaymentAlert
    {
            ...
            try
             {
                ...
                if (MessageObject != null)
                {
                    ...
                    string txtSadadAlertfr = string.Empty;
                    string txtSadadAlertdup = string.Empty;
                    string strGetStatus = string.Empty;

                    //This is to check the transaction exists in new mysql table -- Added by Satish : 15/05/2017
                    txtSadadAlert = "select count(*) from xxi_sadad_alert_log_fr where DESCRIPTION='" + MessageObject.objBody.Description + "'";
                    object checkSptn = clsDatabase.ExecuteScalarmySql(txtSadadAlert);
                    if (checkSptn != null && checkSptn != DBNull.Value && checkSptn.ToString() != "0")
                    {
                        ...
                        clsDatabase.ExecuteNonQuerymySql(txtSadadAlertdup);
                    }
                    else
                    {
                        txtSadadAlertfr = string.Concat(new string[]
                            {
                            "insert into xxi_sadad_alert_log_fr(SENDERID,RECEIVERID,MESSAGETYPE,TIMESTAMP,ACCOUNTNO,AMOUNT,CUSTOMERREFNO,TRANSTYPE,DESCRIPTION,ProcessDate)values('",
                            MessageObject.objHeader.Sender.ToString(),
                            "','",
                            MessageObject.objHeader.Receiver.ToString(),
                            "','",
                        ...
                        clsDatabase.ExecuteNonQuerymySql(txtSadadAlertfr);
        ...
        */
        ...
        public string SadadPaymentInsert(Message MessageObject)
        {
            ...
            try
            {
                if (MessageObject != null)
                {
                    ...
                    if ((objCheckData != null) && (objCheckData != DBNull.Value) && (objCheckData.ToString() != "0"))
                    {
                        ...
                        if ((objCheckData.ToString() == "PROCESSED") || (objCheckData.ToString() == "NEW") || (objCheckData.ToString() == "PROCESS_DP") || (objCheckData.ToString() == "DUPLICATE"))
                        {
                            txtSadadAlertdup = string.Concat(new string[]
                            {
                                        "insert into xxi_sadad_alert_log_dup(SENDERID,RECEIVERID,MESSAGETYPE,TIMESTAMP,ACCOUNTNO,AMOUNT,CUSTOMERREFNO,TRANSTYPE,DESCRIPTION,SADADID)values('",
                            ...
                            retValue = objCheckData.ToString();
                            ...
                            txtSadadAlert = string.Concat(new string[]
                    {
                            ...
                            if (obj2 != null && obj2 != DBNull.Value && int.Parse(obj2.ToString().Trim()) == 1)
                            {
                                ...
                                if (obj3 != null && obj3 != DBNull.Value)
                                {
                                    ...
                                    //txtSadadAlert = "Update xxi_sadad_alert_log_fr set STATUS = '" + obj3.ToString() + "', CreatedOn = '" + System.DateTime.Now + "' where DESCRIPTION='" + dr["DESCRIPTION"].ToString().Trim() + "'";
